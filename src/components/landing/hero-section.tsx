...
export function HeroSection() {
    ...
    return (
        ...
        >
            ...
            >
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/20 rounded-lg blur-[120px]" />
                <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-blue-500/20 rounded-lg blur-[100px]" />
            </motion.div>
            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md mb-4">
                        <span className="flex h-2 w-2 relative">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-lg bg-primary opacity-75"></span>
                            <span className="relative inline-flex rounded-lg h-2 w-2 bg-primary"></span>
                        </span>
                        <span className="text-xs font-semibold capitalize tracking-wider text-muted-foreground">Acesso Antecipado</span>
                    </div>
                ...
                >
                    <div className="relative rounded-[2rem] sm:rounded-[2.5rem] border border-white/10 shadow-2xl bg-black/50 backdrop-blur-xl overflow-hidden aspect-video transform-gpu rotate-x-[15deg] hover:rotate-x-0 transition-transform duration-1000">
                        <div className="absolute inset-x-0 top-0 h-10 bg-white/5 border-b border-white/10 flex items-center px-4 gap-2">
                            <div className="size-3 rounded-lg bg-red-400/80" />
                            <div className="size-3 rounded-lg bg-yellow-400/80" />
                            <div className="size-3 rounded-lg bg-green-400/80" />
                        </div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center flex-col gap-4">
                            <h3 className="text-xl sm:text-3xl font-bold bg-black/50 px-6 py-3 rounded-lg backdrop-blur-md border border-white/10">O teu plano semanal</h3>
                        </div>
                    </div>
                </motion.div>
            </div>
