...
export function PlatformSetting({
    ...
    async function handleSave() {
        ...
        try {
            ...
            toast.error("Failed to update some platform settings")
        } finally {
            setIsLoading(false)
        }
    }
    ...
    return (
        <Card className="border-border/60 bg-card shadow-none overflow-hidden">
            <CardHeader className="border-b border-border/50 py-4 px-6 bg-muted/5">
                <CardTitle className="text-[14px] font-bold text-foreground/90">Platform Configuration</CardTitle>
                <CardDescription className="text-[11px] font-medium text-muted-foreground/70">
                    Manage core settings, branding, and access controls.
                </CardDescription>
            </CardHeader>
            <CardContent className="pt-8 space-y-10 px-8">
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] font-bold capitalize tracking-widest text-primary/70">Identity & Branding</span>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg border border-border/40 bg-muted/5">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-muted-foreground">
                                If disabled, new users will not be able to sign up independently.
                            </p>
                        </div>
                        <Switch
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] font-bold capitalize tracking-widest text-primary/70">Support & Contact</span>
                        <div className="h-px flex-1 bg-border/40" />
                    </div>
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] font-bold capitalize tracking-widest text-primary/70">Social & Legal</span>
                        <div className="h-px flex-1 bg-border/40" />
                    </div>
            ...
            <CardFooter className="bg-muted/30 border-t py-4 flex justify-end">
                ...
                >
                    {isLoading ? "Saving Settings..." : "Update Platform Config"}
                </Button>
            </CardFooter>
        </Card>
    )
