    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                ...
                >
                    ...
                    <div className="hidden md:flex flex-col items-start gap-0.5 text-left">
                        <span className="text-[11px] font-semibold leading-none tracking-tight text-foreground">{user.name || t("adminPanel")}</span>
                    </div>
            ...
            >
                <div className="px-2 pb-2 mb-2 border-b border-sidebar-border/30">
                    <div className="flex items-center gap-3 p-2 bg-sidebar-accent/20 rounded-lg">
                        ...
                        <div className="flex flex-col min-w-0">
                            <span className="text-xs font-semibold truncate">{user.name || t("admin")}</span>
                ...
                <DropdownMenuSub>
                    <DropdownMenuSubTrigger className="rounded-lg px-3 py-2 text-xs flex items-center gap-2.5 hover:bg-accent/50 transition-all cursor-pointer mb-1">
                ...
                <DropdownMenuItem
                    ...
                    className="rounded-lg transition-all font-semibold p-2.5 cursor-pointer hover:bg-accent focus:bg-accent group/logout"
                >
