            ...
            <DropdownMenuTrigger asChild>
                ...
                >
                    ...
                    <div className="hidden md:flex flex-col items-start gap-0.5 text-left">
                        <span className="text-[11px] font-semibold leading-none tracking-tight text-foreground">{t("adminPanel")}</span>
                    </div>
                ...
                <div className="px-2 pb-2 mb-2 border-b border-sidebar-border/30">
                    <div className="flex items-center gap-3 p-2 bg-sidebar-accent/20 rounded-lg">
                        ...
                        <div className="flex flex-col min-w-0">
                            <span className="text-xs font-semibold truncate">{t("admin")}</span>
