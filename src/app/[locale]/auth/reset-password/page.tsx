...
export default async function ResetPasswordPage() {
    ...
    return (
        <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden p-6 md:p-8 bg-linear-to-br from-zinc-100 via-white to-zinc-200 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
            ...
            <div className="relative z-10 w-full max-w-[440px] p-8 sm:p-10 lg:p-12 space-y-10 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-xl dark:shadow-2xl rounded-[2.5rem] animate-in fade-in slide-in-from-bottom-8 duration-1000 transition-colors">
